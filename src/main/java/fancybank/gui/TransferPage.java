/*
 * Page to transfer money between accounts
 */
...
public class TransferPage extends javax.swing.JFrame {
        ...
        public TransferPage(Customer c) {
                ...
                for (int i = 0; i < all_account.size(); i++) {
                        ...
                        this.from_acc_box.addItem(acc.getAccountType() + " Account("
                                        + acc.getBalance().getCurrency().getName() + "):" + acc.getAccountNumber()
                                        + ",Balance: " + acc.getBalance().get());
                        this.to_acc_box.addItem(acc.getAccountType() + " Account("
                                        + acc.getBalance().getCurrency().getName() + "):" + acc.getAccountNumber()
                                        + ",Balance: " + acc.getBalance().get());
                }
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(layout.createSequentialGroup()
                                                                .addGap(198, 198, 198)
                                                                .addComponent(transfer_submit_button,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                120,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGap(68, 68, 68)
                                                                .addComponent(transfer_cancel_button,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                120,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        private void transfer_submit_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_transfer_submit_buttonActionPerformed
                ...
                if (to_acc instanceof SecurityAccount) {
                        ...
                        if (from_bal < 5000 || transfer_amount < 1000 || from_bal < transfer_amount
                                        || from_bal - transfer_amount < 2500) {
                                JOptionPane.showMessageDialog(this,
                                                "Transfer amount doesn't satisfy security transfer requirement!",
                                                "Swing Tester", JOptionPane.WARNING_MESSAGE);
                                return;
                        }
                }
                ...
                Transaction t = new CashTransaction(((Account) from_acc).getAccountNumber(),
                                ((Account) to_acc).getAccountNumber(), new Money(cur, transfer_amount));
