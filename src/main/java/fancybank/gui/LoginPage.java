...
public class LoginPage extends javax.swing.JFrame {
    ...
    public LoginPage() {
         ...
         * Customer(1,"username","firstname","middle","lastname","888
         * Commonwealth","boston","MA","02446","US","gmail.com","123456");
    ...
    private void login_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_login_buttonActionPerformed
        ...
        // Manager m = new Manager(new UID(1),new Username("managerUsername"),new
        // Name("f","m","l"),new Address("888","boston","MA","02446","US"),new
        // Email("gmail"),new Password("123456"));
        /***
         * Customer customer = new
         * Customer(1,"username","firstname","middle","lastname","888
         * Commonwealth","boston","MA","02446","US","gmail.com","123456");
