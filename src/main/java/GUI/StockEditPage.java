...
public class StockEditPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {add_stock_name_text, add_stock_num_text, add_stock_price_text});
    ...
    private void delete_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_buttonActionPerformed
        ...
        if(row<0){JOptionPane.showMessageDialog(null, "No stock is selected.", "No selection", JOptionPane.ERROR_MESSAGE);}
        else{
            DefaultTableModel table= (DefaultTableModel)stock_table.getModel(); 
            table.removeRow(row);
        }
